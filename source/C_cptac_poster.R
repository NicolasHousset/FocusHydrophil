...
## QUARTS was an attempt to perform better than ELUDE with the LTS part
## After careful analysis, the LTS algorithm remains better
## In the rush of making the poster, I included a graph based on QUARTS
...
load(file= paste0(projectPath, "/data/CPTAC_predicted_V2.RData"))
