...
# As usual both runnable under UNIX or Windows
...
load(file= paste0(dataPath, "/CPTAC_processed_V2.RData"))
...
# We only keep identifications where the q value of percolator is less than 1%
...
save(globalResults, file =  paste0(projectPath,"/data/CPTAC_predicted_V2.RData"), compression_level=1)
